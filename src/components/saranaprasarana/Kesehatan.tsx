...
const kesehatanData = [
  {
    nama: "Puskesmas Kota A",
    alamat: "Jl. Sehat No. 3, Kota A",
    gambar: "/kesehatan/puskesmas1.jpg",
  },
  {
    nama: "Rumah Sakit Umum Kota B",
    alamat: "Jl. Medis No. 8, Kota B",
    gambar: "/kesehatan/rsu2.jpg",
  },
  {
    nama: "Klinik Pratama Kota C",
    alamat: "Jl. Dokter No. 12, Kota C",
    gambar: "/kesehatan/klinik3.jpg",
  },
];
