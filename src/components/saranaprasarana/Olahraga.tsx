...
const olahragaData = [
  {
    nama: "Gelanggang Olahraga Kota A",
    alamat: "Jl. Atletik No. 10, Kota A",
    gambar: "/olahraga/gor1.jpg",
  },
  {
    nama: "Stadion Utama Kota B",
    alamat: "Jl. Sepakbola No. 20, Kota B",
    gambar: "/olahraga/stadion2.jpg",
  },
  {
    nama: "Lapangan Basket Kota C",
    alamat: "Jl. Olahraga No. 5, Kota C",
    gambar: "/olahraga/lapangan3.jpg",
  },
];
